...
\author[Sample \textit{et~al}]{Alice Cleynen\,$^{1,*}$, Guillem Rigaill\,$^{2}$ and St\'{e}phane Robin\,$^1$\footnote{to whom correspondence should be addressed}}
...
\bibitem[Guedon, 2008]{guedon_2008} Guédon, Y. (2008) Exploring the segmentation space for the assessment of multiple change-points models. {\it Technical report, Preprint INRIA} {\bf 6619}
