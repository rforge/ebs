...
The package has been developped for the analysis of biological data. For this matter, the Normal Heteroscedastic model, relevant for CGH-arrays, and the Poisson and Negative Binomial (with known overdispersion parameter) models, relevant for NGS-data have been implemented. 
